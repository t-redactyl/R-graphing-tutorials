...
```{r setup, cache = FALSE, message = FALSE, warning = FALSE, tidy = FALSE}
...
The default size of the the data points in a scatterplot is mapped to the radius of the plots. 

```{r scatter11, cache = TRUE}
p1 <- p1
p1
```
