...
knitr::opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 100, fig.width=6, fig.height=5, tidy = F, cache.path = '.cache/', fig.path = '7_Histograms/')
```
...
```{r histogram_importing_font_xkcd, eval=FALSE}
library(extrafont)
