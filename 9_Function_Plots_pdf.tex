...
\hypersetup{unicode=true,
            pdftitle={Creating plots in R using ggplot2 - part 9: function plots},
...
\setlength{\droptitle}{-2em}
  \title{Creating plots in R using ggplot2 - part 9: function plots}
...
This is the ninth tutorial in a series on using \texttt{ggplot2} I am
...
options the \texttt{ggplot2} package has for plotting and customising
functions.

In this tutorial, we will work towards creating the function plot below.
We will take you from a basic function plot and explain all the
customisations we add to the code step-by-step.

\begin{center}\includegraphics{9_Function_Plots_pdf/function_final-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_1-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_2-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_3-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_4-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_5-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_6-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_7-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_8-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_9-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_10-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_11-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_12-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_13-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_14-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_15-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_16-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_17-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_18-1} \end{center}
...
\begin{center}\includegraphics{9_Function_Plots_pdf/function_19-1} \end{center}
