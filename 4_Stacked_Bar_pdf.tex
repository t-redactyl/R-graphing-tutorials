...
\hypersetup{unicode=true,
            pdftitle={Creating plots in R using ggplot2 - part 4: stacked bar plots},
...
\setlength{\droptitle}{-2em}
  \title{Creating plots in R using ggplot2 - part 4: stacked bar plots}
...
In this fourth tutorial I am doing with
...
has for creating and customising stacked bar plots. We will use the same
...
In this tutorial, we will work towards creating the bar plot below. We
will take you from a basic stacked bar plot and explain all the
customisations we add to the code step-by-step.

\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_finalresult-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p4 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{() +}\StringTok{ }\KeywordTok{geom_bar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \NormalTok{percentage, }\DataTypeTok{x =} \NormalTok{year, }\DataTypeTok{fill =} \NormalTok{product), }\DataTypeTok{data =} \NormalTok{charts.data, }\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{)}
\NormalTok{p4}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_1-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_2-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_3-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_4-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_5-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_6-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_7-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_8-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_9-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_10-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_11-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_12-1} \end{center}
...
\begin{center}\includegraphics{4_Stacked_Bar_pdf/stacked_13-1} \end{center}
