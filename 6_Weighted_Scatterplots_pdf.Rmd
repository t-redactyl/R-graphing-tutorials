...
knitr::opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 96, fig.width=8, fig.height=5, tidy = F, cache.path = '6_Weighted_Scatterplots_cache_pdf/', fig.path = '6_Weighted_Scatterplots_pdf/', dev = 'quartz_pdf', dev.args=list(pointsize=12))
```
