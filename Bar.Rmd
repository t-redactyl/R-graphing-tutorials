...
To adjust the position of the data labels from the default placement, we use `ddply` option and specify the `pos` argument to be in the middle of its own color bar.
```{r bar3, cache=TRUE}
