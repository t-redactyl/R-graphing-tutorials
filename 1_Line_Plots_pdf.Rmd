...
knitr::opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 96, fig.width=8, fig.height=6, tidy = F, cache.path = '1_Line_Plots_cache_pdf/', fig.path = '1_Line_Plots_pdf/', dev = 'quartz_pdf', dev.args=list(pointsize=12))
```
