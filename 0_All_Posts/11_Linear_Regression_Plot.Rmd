...
p11 <- ggplot(hsi.ckh.returns, aes(x=hsi.Risk.premium, y=ckh.Return)) + geom_point(shape=1) + geom_smooth(method=lm, se=FALSE) +
      ...
      geom_text(x = 0.05, y = -0.05, label = equation(fit), family="sans", size=5, parse = TRUE) + 
