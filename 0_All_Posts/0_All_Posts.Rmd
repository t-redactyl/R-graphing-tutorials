...
knitr::opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 96, fig.width=8, fig.height=6, tidy = F, cache.path = '.cache/', fig.path = '0_all_posts/')
```
...
# Linear regression
```{r child = '12_Linear_Regression_Plot.Rmd'}
```
