...
knitr::opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 96, fig.width=7.5, fig.height=5, tidy = F, cache.path = '.cache/', fig.path = '0_all_posts/')
```
...
# Linear regression
```{r child = '11_Linear_Regression_Plot.Rmd'}
```
