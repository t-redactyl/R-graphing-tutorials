...
\hypersetup{unicode=true,
            pdftitle={Creating plots in R using ggplot2 - Parts 1-9},
            pdfauthor={Jodie Burchell; Mauricio Vargas Sepúlveda 帕夏},
            pdfborder={0 0 0},
            breaklinks=true}
...
\subsubsection{Creating your own theme}\label{creating-your-own-theme-1}
...
\subsubsection{Creating your own theme}\label{creating-your-own-theme-3}
