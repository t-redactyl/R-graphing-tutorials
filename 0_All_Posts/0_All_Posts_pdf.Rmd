...
knitr::opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 200, fig.width=6, fig.height=5, tidy = F, cache.path = '.cache/', fig.path = '0_all_posts_pdf/', dev = 'png')
```
