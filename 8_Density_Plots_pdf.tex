...
\hypersetup{unicode=true,
            pdftitle={Creating plots in R using ggplot2 - part 8: density plots},
...
\setlength{\droptitle}{-2em}
  \title{Creating plots in R using ggplot2 - part 8: density plots}
...
This is the eight tutorial in a series on using \texttt{ggplot2} I am
...
In this tutorial, we will work towards creating the density plot below.
We will take you from a basic density plot and explain all the
customisations we add to the code step-by-step.

\begin{center}\includegraphics{8_Density_Plots_pdf/density_final-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_1-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_2-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_3-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_4-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_5-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_6-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_7-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_8-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_9-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_10-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_11-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_12-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_13-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_14-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_15-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_16-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_17-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_18-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_19-1} \end{center}
...
\begin{center}\includegraphics{8_Density_Plots_pdf/density_20-1} \end{center}
