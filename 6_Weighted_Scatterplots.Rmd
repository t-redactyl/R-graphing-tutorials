...
knitr::opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 96, fig.width=7.5, fig.height=5, tidy = F, cache.path = '.cache/', fig.path = '6_Weighted_Scatterplots/')
```
...
```{r importing_font_xkcd, eval=FALSE, cache=TRUE}
library(extrafont)
