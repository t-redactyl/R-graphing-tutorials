\chapter{Density plots}

In this chapter, we will work towards creating the density plot below.
We will take you from a basic density plot and explain all the
customisations we add to the code step-by-step.

\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_final-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_1-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_2-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_3-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{p8 <-}\StringTok{ }\NormalTok{p8 +}\StringTok{ }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{name =} \StringTok{"Mean ozone in}\CharTok{\textbackslash{}n}\StringTok{parts per billion"}\NormalTok{,}
     \DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{200}\NormalTok{, }\DecValTok{25}\NormalTok{), }\DataTypeTok{limits=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{200}\NormalTok{))}
\NormalTok{p8}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_4-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_5-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_6-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_7-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{p8 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(airquality, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{Ozone)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_density}\NormalTok{(}\DataTypeTok{fill =} \NormalTok{fill, }\DataTypeTok{colour =} \NormalTok{line, }\DataTypeTok{alpha =} \FloatTok{0.6}\NormalTok{) +}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{name =} \StringTok{"Mean ozone in}\CharTok{\textbackslash{}n}\StringTok{parts per billion"}\NormalTok{,}
    \DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{200}\NormalTok{, }\DecValTok{25}\NormalTok{), }\DataTypeTok{limits=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{200}\NormalTok{)) +}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{name =} \StringTok{"Density"}\NormalTok{) +}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Density plot of mean ozone"}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_8-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_9-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_10-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_11-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_12-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_13-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_14-1} \end{center}
...
\StringTok{  }\KeywordTok{geom_density}\NormalTok{(}\DataTypeTok{fill =} \NormalTok{fill, }\DataTypeTok{colour =} \NormalTok{line, }\DataTypeTok{alpha =} \FloatTok{0.6}\NormalTok{) +}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{name =} \StringTok{"Mean ozone in}\CharTok{\textbackslash{}n}\StringTok{parts per billion"}\NormalTok{,}
    \DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{200}\NormalTok{, }\DecValTok{50}\NormalTok{), }\DataTypeTok{limits=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{200}\NormalTok{)) +}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{name =} \StringTok{"Density"}\NormalTok{) +}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Density plot of mean ozone"}\NormalTok{) +}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_15-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_16-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_17-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_18-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_19-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{8_Density_Plots_pdf/density_20-1} \end{center}
