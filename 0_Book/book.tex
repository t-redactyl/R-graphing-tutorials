...
%%%% CONTENIDO MODIFICADO DEL TEX GENERADO POR RSTUDIO %%%

\include{1_Line_Plots_pdf}
\include{2_Area_Plots_pdf}
\include{3_Bar_Plots_pdf}
\include{4_Stacked_Bar_pdf}
\include{5_Scatter_Plots_pdf}
\include{6_Weighted_Scatterplots_pdf}
\include{7_Histograms_pdf}
\include{8_Density_Plots_pdf}
\include{9_Function_Plots_pdf}
\include{10_Boxplots_pdf}
\include{11_Linear_Regression_Plot_pdf}
