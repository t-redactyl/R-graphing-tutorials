...
I'll include in this template an example graph from your Chile-China trade analysis or from my blog/other projects.
...
```{r example stacked_bar_plot}
cbPalette3 <- c("#56B4E9", "#F0E442")

p10 <- ggplot() + geom_bar(aes(y = porcentaje, x = anio, fill = producto), data = data4, stat="identity")
p10 <- p10 + scale_fill_manual(values=cbPalette3) + 
    geom_text(data=data4, aes(x = anio, y = pos, label = paste0(porcentaje,"%")), 
              colour="black", family="xkcd-Regular", size = 5)
p10 <- p10 + scale_x_continuous(breaks=seq(2006,2014,1)) + 
    scale_y_continuous(labels = dollar_format(suffix = "%", prefix = "")) + 
    labs(x="Year", y="Percentage")  + theme_xkcd()
...
There are a few histograms on this post on my blog: http://t-redactyl.github.io/blog/2015/09/A-Gentle-Introduction-to-the-Standard-Error-of-the-Mean.html

## Density plots

There are about 6 density plots towards the bottom of my Practical Machine Learning assignment: http://t-redactyl.github.io/Practical-Machine-Learning-Report/Practical_Machine_Learning_Report.html

## Plotting functions

There are a couple of function plots towards the bottom of this blog post: http://t-redactyl.github.io/blog/2015/09/two-group-hypothesis-testing-independent-samples-t-tests.html

## Customisation

Different customisation options could be presented with each plot and then summarised again separately. Here are a few I have thought of from your and my work.
