...
knitr::opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 96, fig.width=6, fig.height=5, tidy = F, cache.path = '5_Scatter_Plots_cache_pdf/', fig.path = '5_Scatter_Plots_pdf/', dev = 'quartz_pdf', dev.args=list(pointsize=12))
```
