...
\begin{tcolorbox}[colback=white,colframe=blue!75!black,title=\textbf{LIST OF TO DO'S}]
\begin{enumerate}
\item This contains only parts 1-10 !!
\item Add references !
\item Put introduction blah blah blah
\end{enumerate}
\end{tcolorbox}
\bigskip
...
Vargas Sep\'ulveda} to create some graphing tutorials in R. In the coming
