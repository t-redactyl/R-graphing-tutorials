...
\documentclass[11pt,letterpaper,oneside,svgnames,x11names]{article}
\leftmargin=0.25in
...
\usepackage{color}
\usepackage{colortbl}
\usepackage{float}  % imagen sin que se mueva
\hypersetup{pdfstartview={XYZ null null 1.20}}
\usepackage{chngpage}
\usepackage{soul}
\sodef\myspace{}{.3em}{1em plus1em}{2em plus.1em minus.1em}
\usepackage{footnote}
...
{\sffamily 
	\begin{center}
		\vspace*{\fill}
		\HRule \\[0.4cm]{
		\huge \bfseries Creating plots in R using ggplot2}\\ [0.4cm]
		\HRule \\[1.5cm]
		% Autor
...
\begin{tcolorbox}[colback=white,colframe=blue!75!black,title=\textbf{Insert something here}]
\begin{enumerate}
\item This contains only parts 1-10 !!
\end{enumerate}
\end{tcolorbox}
\bigskip
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_final-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_1-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_2-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_3-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_4-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_5-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_6-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_7-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_8-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_9-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/area_11-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/bar_2-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/bar_3-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/bar_5-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/bar_7-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/bar_9-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/bar_11-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/bar_13-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/scatter_5-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/scatter_6-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/scatter_9-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/scatter_12-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/scatter_13-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/scatter_14-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/scatter_15-1} \end{center}
...
\subsection{Using the white theme}\label{using-the-white-theme-6}
...
\subsection{Creating your own theme}\label{creating-your-own-theme-6}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_final-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_1-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_2-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_3-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_4-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_5-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_6-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_7-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_8-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_9-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_10-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_11-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_12-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_13-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_14-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_15-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_16-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_17-1} \end{center}
...
\begin{center}\includegraphics[width=0.55\linewidth]{0_all_posts_pdf/box_18-1} \end{center}
